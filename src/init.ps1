...
Add-HostsEntry "cm.vscodeeditor.localhost"
if ($Topology -ne "xp0") {
  Add-HostsEntry "cd.vscodeeditor.localhost"
}
Add-HostsEntry "id.vscodeeditor.localhost"
Add-HostsEntry "www.vscodeeditor.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "cm.vscodeeditor.localhost"

    if ($Topology -ne "xp0") {
      # CD_HOST
      Set-EnvFileVariable "CD_HOST" -Value "cd.vscodeeditor.localhost"
    }

    # ID_HOST
    Set-EnvFileVariable "ID_HOST" -Value "id.vscodeeditor.localhost"

    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.vscodeeditor.localhost"
