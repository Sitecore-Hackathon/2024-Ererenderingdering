...
if ($ByPass) {
  dotnet sitecore login --cm https://cm.vscodeeditor.localhost/ --auth https://id.vscodeeditor.localhost/ --allow-write true --client-id "SitecoreCLIServer" --client-secret "testsecret" --client-credentials true
}else {
  dotnet sitecore login --cm https://cm.vscodeeditor.localhost/ --auth https://id.vscodeeditor.localhost/ --allow-write true
}
